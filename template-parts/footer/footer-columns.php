<?php
$footer_section = get_theme_mod( 'advance_fitness_gym_pro_footer_widgets_enable' );
if ( 'Disable' == $footer_section ) {
	return;
}
if( get_theme_mod('advance_fitness_gym_pro_footer_widget_bgcolor') ) {
  $about_backg = 'background-color:'.esc_attr(get_theme_mod('advance_fitness_gym_pro_footer_widget_bgcolor')).';';
}elseif( get_theme_mod('advance_fitness_gym_pro_footer_widget_bgimage') ){
  $about_backg = 'background-image:url(\''.esc_url(get_theme_mod('advance_fitness_gym_pro_footer_widget_bgimage')).'\')';
}else{
  $about_backg = '';
}
?>
