jQuery( document ).ready(function($) {
	...
	$('.sortable_repeater_control').each(function() {
		...
		var defaultValuesArray = new Array("exercise","welcome","services-we-offer","special-offer","facilities","popular-programs","bmi","membership","our-team","get-in-touch","testimonial","record","our-partners");
